...
namespace Chummer
{
    ...
    public static class GlobalOptions
    {
        ...
        public static ToolTip ToolTipProcessor
        {
            get;
        } = new TheArtOfDev.HtmlRenderer.WinForms.HtmlToolTip
        {
            UseAnimation = true,
        ...
        // Plugins information
        private static readonly Dictionary<string, bool> _pluginsEnabledDic = new Dictionary<string, bool>();
        public static Dictionary<string, bool> PluginsEnabledDic => _pluginsEnabledDic;
        ...
        public static string PDFArguments
        {
            get; internal set;
        }
        #endregion
