...
namespace ChummerHub.Client.UI
{
    public partial class ucSINnerGroupCreate : UserControl
    {
        ...
        public ucSINnerGroupCreate() => InitializeComponent();
        ...
        public void InitializeMe(bool onlyPWHash)
        {
            ...
            if (MyGroup != null)
            {
                ...
                {
                    cboLanguage1.SelectedValue = MyGroup.Language;
                }
                else
                {
                    cboLanguage1.SelectedValue = GlobalOptions.Language;
                }
        ...
        private void BOk_Click(object sender, EventArgs e) => MyGroup = SaveValues(MyGroup);
        ...
        private SINnerGroup SaveValues(SINnerGroup myGroup)
        {
            ...
            Guid id = Guid.Empty;
            myGroup.Id = Guid.TryParse(tbGroupId.Text, out id) ? id : Guid.NewGuid();
